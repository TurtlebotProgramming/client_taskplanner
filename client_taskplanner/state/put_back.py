...
class PutBackState:
    ...
    def init(self, bb: Blackboard, saved_object, send_nav_goal, logger, send_gripper) -> None:
        ...
        self._saved_object = saved_object
        self._logger = logger
        ...
        send_gripper(1, self._on_grip_done)

    def tick(self, bb: Blackboard, logger, send_gripper) -> None:
        pass

    def _on_grip_done(self, ok: bool):
        if ok:
            self._send_nav_goal(*self._saved_object, self._on_nav_done)
